...
@Component({
  selector: 'app-root',
  imports: [NavbarComponent, HeroComponent, AboutComponent, PartnersComponent, ServicesComponent, FoundersComponent, ContactComponent, FooterComponent, TyroUiNavbar, TyroUiFooter],
